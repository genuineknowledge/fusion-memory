...
async def system_prompt_builder() -> str:
    ...
    return (
        ...
        "At the start of each new interactive session, before ordinary task work and before the first use of Fusion Memory, "
        ...
        "If the user agrees, use the fusion-memory-setup skill to initialize, start, check the Fusion Memory service, and start and verify passive sync. "
